...
- [x] 1. Vision Service WebSocket Endpoint
  - [x] 1.1 Add YOLOv8 dependencies and model loading to ml-service
  ...
  - [x] 1.2 Implement `/vision-stream` WebSocket endpoint with frame processing
  ...
  - [x] 1.3 Implement frame-skip strategy and performance logging
  ...
  - [x] 1.4 Configure CORS/Origin validation for Vision Service
...
- [x] 2. Checkpoint - Ensure Vision Service tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Backend Gateway Chat Endpoint
  - [x] 3.1 Create Next.js API route for triage chat
  ...
  - [x] 3.2 Implement Gemini API integration with system prompt
  ...
  - [x] 3.3 Configure CORS for Backend Gateway
...
- [x] 4. Checkpoint - Ensure Backend Gateway tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Triage Room UI - Video and Canvas Foundation
  - [x] 5.1 Create TriageRoom page and layout component
  ...
  - [x] 5.2 Implement VideoFeed component with webcam access
  ...
  - [x] 5.3 Implement canvas overlay with resize synchronization
...
- [x] 6. Triage Room UI - Frame Streaming and Bounding Boxes
  - [x] 6.1 Implement FrameStreamer with WebSocket transmission
  ...
  - [x] 6.2 Implement BoundingBoxRenderer on canvas
...
- [ ] 7. Triage Room UI - Chat Panel and TTS
  - [x] 7.1 Implement ChatPanel component
  ...
  - [x] 7.2 Implement chat API integration
  ...
  - [x] 7.3 Implement TTSController with mute toggle
...
- [x] 8. Triage Room UI - Session Lifecycle Wiring
  - [x] 8.1 Wire full session start flow
  ...
  - [x] 8.2 Wire full session end flow
