...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-10">
      ...
      {/* Profile header */}
      <div className="rounded-2xl p-6 mb-6 animate-fade-up" style={{ background: "#111113", border: "1px solid #27272a" }}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl font-bold truncate" style={{ fontFamily: "Syne, sans-serif", color: "#fafafa" }}>
              {profile.name}
            </h1>
            <p className="text-sm mt-0.5" style={{ color: "#52525b", fontFamily: "Figtree, sans-serif" }}>
        ...
        {saved && (
          <p className="text-xs mt-3 font-semibold" style={{ color: "#10b981", fontFamily: "Figtree, sans-serif" }}>
            ✓ Profile updated
          </p>
        )}
      </div>
      ...
      {/* Edit panel */}
      {editing && (
        <div className="rounded-2xl p-6 mb-6 animate-fade-up" style={{ background: "#111113", border: "1px solid rgba(16,185,129,0.3)" }}>
          <h2 className="font-bold mb-4" style={{ fontFamily: "Syne, sans-serif", color: "#fafafa" }}>Edit Profile</h2>
          ...
          <div className="space-y-3">
            {(
              ...
              <div key={key}>
                <label className="block text-xs font-semibold mb-1" style={{ color: "#52525b", fontFamily: "Figtree, sans-serif" }}>
                  {label}
                </label>
                <input
                  type={type}
                  ...
                  style={{
                    ...
                    color: "#fafafa", fontFamily: "Figtree, sans-serif",
                  }}
              ...
              <div className="flex gap-2">
                {["Low", "Medium", "High"].map((opt) => (
                  <button
                    ...
                    style={{
                      background: draft.eco_preference === opt ? "rgba(16,185,129,0.15)" : "#18181b",
                      border: draft.eco_preference === opt ? "1px solid rgba(16,185,129,0.4)" : "1px solid #3f3f46",
                      color: draft.eco_preference === opt ? "#10b981" : "#52525b",
          ...
          <div className="flex gap-3 mt-5">
            ...
            <button
              ...
              style={{ background: "#18181b", color: "#52525b", border: "1px solid #27272a", fontFamily: "Figtree, sans-serif" }}
            >
              Cancel
            </button>
          </div>
      ...
      <div className="flex items-center justify-between mb-4 animate-fade-up delay-1">
        <h2 className="text-lg font-bold" style={{ fontFamily: "Syne, sans-serif", color: "#fafafa" }}>My Orders</h2>
        <span className="text-xs" style={{ color: "#52525b", fontFamily: "Figtree, sans-serif" }}>{ORDERS.length} orders</span>
      </div>
      ...
      <div className="space-y-3 animate-fade-up delay-1">
        {ORDERS.map((order) => {
          ...
          return (
            ...
            >
              <div className="w-14 h-14 rounded-xl overflow-hidden flex-shrink-0" style={{ background: "#18181b" }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={order.image} alt={order.product_name} className="w-full h-full object-cover" />
              </div>

              <div className="flex-1 min-w-0">
                <p className="font-semibold text-sm truncate" style={{ color: "#fafafa", fontFamily: "Figtree, sans-serif" }}>
                  {order.product_name}
                </p>
              ...
              {order.returnable ? (
                <button
                  ...
                  className="flex-shrink-0 px-4 py-2 rounded-xl text-sm font-semibold transition-all hover:opacity-90 active:scale-[0.98]"
                  style={{ background: "#10b981", color: "#0c0c0e", fontFamily: "Figtree, sans-serif" }}
                >
                  Return ♻
                </button>
              ) : (
                <span className="flex-shrink-0 text-xs px-3 py-2 rounded-xl" style={{ background: "#18181b", color: "#3f3f46", border: "1px solid #27272a", fontFamily: "Figtree, sans-serif" }}>
      ...
      <div className="mt-8 text-center animate-fade-up">
        <Link href="/marketplace" className="text-sm font-semibold" style={{ color: "#10b981", fontFamily: "Figtree, sans-serif" }}>
